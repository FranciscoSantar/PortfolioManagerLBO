...
export class ReportsController {
  ...
  @ApiOperation({ summary: 'Generate an Excel report for a specific portfolio' })
  @ApiOkResponse({ description: 'The Excel report has been successfully generated and is being downloaded.' })
