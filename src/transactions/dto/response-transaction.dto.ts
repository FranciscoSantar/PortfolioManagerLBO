...
export class ShortResponseTransactionDto {
  ...
  @ApiProperty({
    description: 'The unit price of the asset at the time of the transaction',
    example: 150.25,
  })
  unitPrice: number;

  @ApiProperty({
    description: 'The value of the commission applied to the transaction',
    example: 5.0,
  })
  commission?: number;
}
...
export class ResponseTransactionsWithTotalCommissionDto {
  ...
  @ApiProperty({
    description: 'The total commission amount for the listed transactions',
    example: 25.0,
  })
...
export class ResponseAllTransactionsOfPortfolioAssetDto {
  @ApiProperty({
    description:
      'List of transactions for the specified asset in the portfolio',
    type: [ShortResponseTransactionDto],
  })
  transactions: ShortResponseTransactionDto[];
