...
export class TransactionsController {
  ...
  @ApiOperation({
    summary: 'Create a new transaction of an asset for a specific portfolio',
  })
  @ApiCreatedResponse({
    description: 'The transaction has been successfully created.',
    type: ShortResponseTransactionDto,
  })
  ...
  @ApiOperation({
    summary:
      'Get all transactions of a specific portfolio and total of commissions spent.',
  })
  @ApiOkResponse({
    description: 'List of transactions retrieved successfully.',
    type: ResponseTransactionsWithTotalCommissionDto,
  })
  ...
  findAllTransactionsInPortfolio(
    ...
    return this.transactionsService.findAllTransactionsInPortfolio(
      portfolioId,
      userId,
      filterDto,
    );
  ...
  findOneTransactionInPortfolio(
    ...
    return this.transactionsService.findOneTransactionInPortfolio(
      transactionId,
      portfolioId,
      userId,
    );
  ...
  @ApiOperation({
    summary:
      'Get all transactions of a specific asset in a portfolio. Also includes asset details.',
  })
  @ApiOkResponse({
    description: 'List of transactions retrieved successfully.',
    type: ResponseAllTransactionsOfPortfolioAssetDto,
  })
  @ApiNotFoundResponse({ description: 'Portfolio or Asset not found' })
  @ApiUnauthorizedResponse({ description: 'Unauthorized' })
  @ApiBearerAuth()
  ...
  findTransactionsOfPortfolioAsset(
    ...
    return this.transactionsService.findAllTransactionsOfPortfolioAsset(
      portfolioId,
      assetId,
      userId,
    );
